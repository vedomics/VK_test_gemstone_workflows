...
workflow SKA_plasmid_masked {
  meta {
    ...
    description: "SKA analysis with plasmid masking using pre-existing plasmid fastas - per-isolate plasmid masking with proper scatter"
  }
  ...
  scatter (i in range(length(samplename))) {
    ...
    # Extract plasmid fastas from corresponding tar.gz
